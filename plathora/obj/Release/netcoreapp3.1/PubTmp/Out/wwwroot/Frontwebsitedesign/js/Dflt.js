...
function BindAllStaticData()
{
    ...
    //if ('@ViewBag.StockList' != '') {

    //    var StockList = '@(ViewBag.StockList)'//@Html.Raw(ViewBag.StockList);
        
    //   // let output = StockList.map(i => "<tr><td>" + i.img + "</td><td>" + i.name + "</td><td>" + i.name + "</td></tr>");
        
    //    for (var item in StockList)
    //    {
    //        alert('FirstName: ' + item.img  + ' LastName:' + item.name );
    //    } 
    //}
    //var someNumericValue = '@(ViewBag.sectorListt)';
     
    //    for (var item in someNumericValue)
    //    {
    //        alert('FirstName: ' + item.img  + ' LastName:' + item.name );
    //    } 
